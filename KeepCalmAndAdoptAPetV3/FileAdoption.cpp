...
void HTMLFileAdoption::display() {
	ShellExecuteA(NULL, "open", "file:///C:/Users/Ilinca/source/repos/KeepCalmAndAdoptAPet/KeepCalmAndAdoptAPet/adoptedDogs.html", filename.c_str(), NULL, SW_SHOWMAXIMIZED);
}
